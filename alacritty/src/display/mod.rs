...
impl Display {
    ...
    pub fn draw<T: EventListener>(
        ...
        let cursor_pos_y = size_info.height() - point.line as f32 * size_info.cell_height() + size_info.padding_y();
        self.renderer.update_render(&size_info, cursor_pos_x, cursor_pos_y);
